...
#process.patMuons.pfCandidateMap = cms.InputTag("particleFlow","muons")
...
#output file
#process.out.fileName = 'file:///cmsdata2/paktinat/JetIDByZest/Jets_PAT_data_500files_0019_New3.root' ##  (e.g. 'myTuple.root')
process.out.fileName = 'file://Jets_PAT_data_500files.root' ##  (e.g. 'myTuple.root')

process.demo = cms.EDAnalyzer('MyTreeProducer',
                              histoname = cms.string("file://Histo.root")
)
