...
#files2011data = FileUtils.loadListFromFile ('CMS_Run2011A_BTag_AOD_12Oct2013-v1_20000_file_index/CMS_Run2011A_BTag_AOD_12Oct2013-v1_20000_file_index_0020') 
files2011data = FileUtils.loadListFromFile ('CMS_Run2011A_DoubleMu_AOD_12Oct2013-v1_10000_file_index/CMS_Run2011A_DoubleMu_AOD_12Oct2013-v1_10000_file_index_0060')
readFiles = cms.untracked.vstring( *files2011data )
process.source.fileNames = readFiles

#output file
process.out.fileName = 'file:///cmsdata2/paktinat/JetIDByZest/CMS_Run2011A_DoubleMu_AOD_12Oct2013-v1_10000_file/DoubleMu_Zpeak_0060.root' ##  (e.g. 'myTuple.root')
#process.out.fileName = 'file://Jets_PAT_data_500files.root' ##  (e.g. 'myTuple.root')

process.demo = cms.EDAnalyzer('MyTreeProducer',
                              histoname = cms.string("file:///cmsdata2/paktinat/JetIDByZest/CMS_Run2011A_DoubleMu_AOD_12Oct2013-v1_10000_file/Histo_DoubleMu_Zpeak_0060.root")
